...
import com.gmail.sneakdevs.content.types.AdvancedSpongeBlock;
...
public class AdvancedSpongeBase extends AdvancedSpongeBlock {

    public AdvancedSpongeBase(String name, float hardness, float resistance, Material material, BlockSoundGroup sound, ItemGroup itemgroup, Tag<Item> tag) {
