...
import com.gmail.sneakdevs.content.types.StrongLavaSpongeBlock;
...
public class StrongLavaSpongeBase extends StrongLavaSpongeBlock {

    public StrongLavaSpongeBase(String name, float hardness, float resistance, Material material, BlockSoundGroup sound, ItemGroup itemgroup, Tag<Item> tag) {
