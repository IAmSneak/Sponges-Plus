...
import com.gmail.sneakdevs.content.types.AdvancedLavaSpongeBlock;
import com.gmail.sneakdevs.content.types.AdvancedWetSpongeBlock;
...
public class AdvancedWetSpongeBase extends AdvancedWetSpongeBlock {

    public AdvancedWetSpongeBase(String name, float hardness, float resistance, Material material, BlockSoundGroup sound, ItemGroup itemgroup, Tag<Item> tag) {
