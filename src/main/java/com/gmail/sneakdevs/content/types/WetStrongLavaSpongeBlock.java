...
public class WetStrongLavaSpongeBlock extends Block {
    protected WetStrongLavaSpongeBlock(Settings settings) {
        super(settings);
    }
    ...
    protected void update(World world, BlockPos pos) {
        if (this.absorbWater(world, pos)) {
            world.setBlockState(pos, LavaSponges.STRONG_LAVA_SPONGE.getDefaultState(), 2);
