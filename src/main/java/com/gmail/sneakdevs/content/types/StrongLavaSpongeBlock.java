...
public class StrongLavaSpongeBlock extends Block {
    protected StrongLavaSpongeBlock(Settings settings) {
        super(settings);
    }
    ...
    protected void update(World world, BlockPos pos) {
        if (this.absorbLava(world, pos)) {
            world.setBlockState(pos, LavaSponges.STRONG_SATURATED_LAVA_SPONGE.getDefaultState(), 2);
