...
public class AdvancedLavaSpongeBlock extends Block {
    protected AdvancedLavaSpongeBlock(Settings settings) {
        super(settings);
    }
    ...
    protected void update(World world, BlockPos pos) {
        if (this.absorbLava(world, pos)) {
            world.setBlockState(pos, LavaSponges.ADVANCED_SATURATED_LAVA_SPONGE.getDefaultState(), 2);
