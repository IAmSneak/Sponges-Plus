...
public class StrongSpongeBlock extends Block {
    protected StrongSpongeBlock(Settings settings) {
        super(settings);
    }
    ...
    protected void update(World world, BlockPos pos) {
        if (this.absorbWater(world, pos)) {
            world.setBlockState(pos, WaterSponges.STRONG_WET_SPONGE.getDefaultState(), 2);
